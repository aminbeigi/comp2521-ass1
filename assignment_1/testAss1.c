...
static void testDbInsertRecord(void) {
    ...
    Record recs[] = {
        ...
        ////////////////////////////MY TESTS//////////////////////////////////
        // accept - max
        RecordNew("zzzzzzzz", "MEL", "BNE", 6, 23, 59, 110),

        // accept - min
        RecordNew("0", "MEL", "BNE", 0, 0, 0, 110),

        // reject - not unique
        RecordNew("0", "ADL", "SYD", 0, 0, 0, 4),

    };
    
    doTestDbInsertRecord(recs, 9);
}
...
static void testDbFindByFlightNumber(void) {
    ...
    ////////////////////////////MY TESTS//////////////////////////////////
    // No flights found
    doTestDbFindByFlightNumber(db, "CAT242");
...
static void testDbFindByDepartureAirportDay(void) {
    ...
    ////////////////////////////MY TESTS//////////////////////////////////
    // empty list
    doTestDbFindByDepartureAirportDay(db, "XYZ", 6);

    // a cheeky test why not
...
static void testDbFindBetweenTimes(void) {
    ...
    ////////////////////////////MY TESTS//////////////////////////////////
    // 51-2-2-2-1-2-2-1
    // return ALL flights (39)
    doTestDbFindBetweenTimes(db, 0, 0, 0, 6, 23, 59);

    // no flights founds
    doTestDbFindBetweenTimes(db, 6, 15, 0, 6, 18, 0);
...
static void testDbFindNextFlight(void) {
    ...
    ////////////////////////////MY TESTS//////////////////////////////////
    doTestDbFindNextFlight(db, "ADL", 0, 0, 0);

    doTestDbFindNextFlight(db, "ADL", 6, 23, 0);

    doTestDbFindNextFlight(db, "ADL", 2, 14, 0);
    
    doTestDbFindNextFlight(db, "NONE", 0, 0, 0);

    doTestDbFindNextFlight(db, "NONE", 6, 23, 0);

    doTestDbFindNextFlight(db, "MEL", 6, 23, 59);
    
    doTestDbFindNextFlight(db, "MEL", 0, 0, 0);
